...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        if out_bbox.dtype == torch.float16 or out_bbox.dtype == torch.bfloat16:
...
def build_matcher(cfg):
    return HungarianMatcher(cost_class=cfg.LOSS.MATCHER.SET_COST_CLASS, 
                            cost_bbox=cfg.LOSS.MATCHER.SET_COST_BBOX, 
                            cost_giou=cfg.LOSS.MATCHER.SET_COST_GIOU,
                            cost_conf=cfg.LOSS.MATCHER.SET_COST_CONF)