...
def dinov3_vitl16_dinotxt_tet1280d20h24l(
    *,
    ...
    return_only_vision_tower: bool = False,
    return_seperate_vision_tower: bool = False,
) -> Tuple[nn.Module, Any]:
    from models.dinov3.eval.text.dinotxt_model import DINOTxt, DINOTxtConfig
    from models.dinov3.eval.text.text_transformer import TextTransformer
    from models.dinov3.eval.text.tokenizer import get_tokenizer
    ...
    if pretrained:
        ...
        model.init_weights()
    if return_only_vision_tower:
        return model.visual_model
    if return_seperate_vision_tower:
        return model.visual_model.backbone, model.visual_model.head
